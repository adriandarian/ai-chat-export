...
function App() {
  ...
  return (
    <div className="h-full flex flex-col bg-background text-text-primary font-sans selection:bg-primary/20 selection:text-primary transition-colors duration-300">
      ...
      {/* Header */}
      <div className="px-6 py-5 border-b border-border flex items-center justify-between bg-surface/80 backdrop-blur-md sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] font-medium text-text-muted mt-1 tracking-wide">AI CONVERSATION SAVER</p>
          </div>
        </div>
        <button 
          onClick={toggleTheme}
          className="p-2 rounded-full transition-colors text-text-muted hover:text-text-primary hover:bg-surface-highlight active:scale-95"
      ...
      <div className="flex-1 p-6 flex flex-col relative overflow-hidden">
        ...
        {error ? (
          ...
          <div className="space-y-8 relative z-0">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="flex flex-col items-center justify-center p-3 rounded-xl border border-border bg-surface/50 hover:bg-surface-highlight hover:border-primary/30 hover:shadow-md transition-all duration-200 group cursor-default">
                <FileText size={20} className="text-text-muted group-hover:text-red-500 transition-colors mb-2" />
                <span className="text-[10px] font-semibold text-text-secondary group-hover:text-text-primary">PDF</span>
              </div>
              <div className="flex flex-col items-center justify-center p-3 rounded-xl border border-border bg-surface/50 hover:bg-surface-highlight hover:border-primary/30 hover:shadow-md transition-all duration-200 group cursor-default">
                <Code size={20} className="text-text-muted group-hover:text-blue-500 transition-colors mb-2" />
                <span className="text-[10px] font-semibold text-text-secondary group-hover:text-text-primary">HTML</span>
              </div>
              <div className="flex flex-col items-center justify-center p-3 rounded-xl border border-border bg-surface/50 hover:bg-surface-highlight hover:border-primary/30 hover:shadow-md transition-all duration-200 group cursor-default">
                <FileJson size={20} className="text-text-muted group-hover:text-amber-500 transition-colors mb-2" />
        ...
        <div className="mt-auto pt-6 relative z-10">
          <button 
            ...
            className="w-full bg-primary hover:bg-primary-hover text-primary-text py-4 rounded-xl font-semibold text-sm shadow-xl shadow-primary/10 hover:shadow-2xl hover:shadow-primary/20 transition-all transform hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-2 group"
          >
          ...
          <div className="mt-5 flex items-center justify-center gap-1.5 text-[10px] text-text-muted font-medium uppercase tracking-wider opacity-60">
            <Sparkles size={10} />
