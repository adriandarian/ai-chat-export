...
function App() {
  ...
  const handleStartSelection = async () => {
    ...
    try {
      ...
      if (
        injectionErr?.message?.includes("Extension context invalidated") ||
      ...
      <div className="px-4 py-3 border-b border-border flex items-center justify-between bg-surface/80 backdrop-blur-md sticky top-0 z-10">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[9px] font-medium text-text-muted mt-0.5 tracking-wide">
          ...
          <div className="space-y-4 relative z-0 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-text-muted leading-relaxed max-w-[240px] mx-auto">
                Select messages from ChatGPT, Claude, and more to export as{" "}
                <span className="text-primary font-semibold">PDF</span>,{" "}
                <span className="text-primary font-semibold">HTML</span>, or{" "}
            ...
            <div className="pt-1">
              ...
              >
                <MousePointer2
                  size={16}
                  className="opacity-80 group-hover:opacity-100 transition-colors"
                />
